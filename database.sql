...
--
-- Struktur dari tabel `pesanaku`
--

CREATE TABLE IF NOT EXISTS `pesanaku` (
  ...
  PRIMARY KEY (`nm_pengirim`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `pesanaku`
--

INSERT INTO `pesanaku` (`nm_pengirim`, `nm_penerima`, `nm_barang`, `jasa_kirim`, `harga`, `jumlah_beli`, `total_harga`, `alamat`) VALUES
('j', 'j', 'j', 'jj', 55, 3, '0', 'jjjjjjj'),
('o', 'o', 'o', 'oo', 6, 3, '', '33333');
