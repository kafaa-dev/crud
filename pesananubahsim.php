...
$update = "UPDATE pesanan SET nm_pengirim='$nm_pengirim', nm_penerima='$nm_penerima', nm_barang='$nm_barang', marketplace='$marketplace', jasa_kirim='$jasa_kirim', harga='$harga', jumlah_beli='$jumlah_beli', alamat='$alamat' WHERE id_pesanan='$id'";
